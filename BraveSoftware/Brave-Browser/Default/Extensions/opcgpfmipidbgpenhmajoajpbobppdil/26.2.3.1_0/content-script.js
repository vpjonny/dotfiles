...
(() => {
  ...
  var IS_WEBSITE = process_exports.env.EXPO_PUBLIC_WEBSITE === "true";
  var IS_WEB = Platform_default.OS === "web";
  ...
  function createExtensionEmitter(opts) {
    ...
    browser2.runtime.onMessage.addListener((message, sender) => {
      if (isReady) {
    ...
    return {
      ...
      emit(eventName, data, tabId) {
        ...
        if (tabId) {
          browser2.tabs.sendMessage(tabId, message);
        } else {
